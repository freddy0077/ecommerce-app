            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <ul class="nav nav-pills nav-stacked nav-email shadow mb-20">
                        <li class="active"><a href="#"> <i></i> My fancies <span class="label label-danger pull-right">7</span> </a></li>

                        <li>
                            <a href="#">
                                <i></i> Followers  <span class="label label-danger pull-right">7</span>
                            </a>
                        </li>
                        <li>
                            <a href="#"><i></i> Following  <span class="label label-danger pull-right">7</span></a>
                        </li>
                        <li>
                            <a href="#"><i class=""></i> Watching  <span class="label label-danger pull-right">7</span></a>
                        </li>
                        <li>
                            <a href="#">
                                <i ></i> Collections  <span class="label label-danger pull-right">7</span>
                            </a>
                        </li>
                    </ul><!-- /.nav -->
