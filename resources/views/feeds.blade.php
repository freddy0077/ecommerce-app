                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <ul class="list-unstyled profile-nav">
                                                    <li>
                                                        <img src="{{asset('backend/assets/pages/media/profile/people19.png')}}" class="img-responsive img-rounded pic-bordered" alt="" />
                        ...
                        <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                            ...
                            <ul class="media-list list-items">
                                <li class="media">
                                    ...
                                    <img class="media-object" src="{{asset('backend/assets/layouts/layout/img/avatar3.jpg')}}" alt="...">
                                ...
                                <li class="media">
                                    <img class="media-object" src="{{asset('backend/assets/layouts/layout/img/avatar1.jpg')}}" alt="...">
                                    <div class="media-body">
