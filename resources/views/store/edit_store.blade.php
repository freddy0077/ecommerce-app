            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-primary" style="margin:20px;">
                    ...
                    <div class="panel-body">
                        <form id="edit_store_form" method="post">
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group col-md-6 col-sm-6">
                                    <label for="name">Name*	</label>
                                    <input type="text" class="form-control input-sm" id="name" name="name" readonly value="{{isset($store->name)?$store->name:""}}" placeholder="your store name" required>
