                                                        ...
                                                        <div class="portlet yellow-crusta box">
                                                            ...
                                                            <div class="portlet-body">
                                                                ...
                                                                <div class="row static-info">
                                                                    ...
                                                                    <div class="col-md-7 value">GHS {{$order->amount}} </div>
                                                                </div>
                                                                {{--<div class="row static-info">--}}
                                                        ...
                                                        <div class="portlet blue-hoki box">
                                                            ...
                                                            <div class="portlet-body">
                                                                ...
                                                                <div class="row static-info">
                                                                    ...
                                                                    <div class="col-md-7 value"> {{$order->user->phone_number}} </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover table-bordered table-striped">
                                                                        ...
                                                                        @foreach($order->items as $item)
                                                                            <tr>
                                                                                <td>
                                                                                    <a href="{{url('store/edit-product',$item->product_id)}}"> {{\App\Product::getProductName($item->product_id)->name}}</a>
                                                                                </td>
                                                                                <td>
                                                                                    <span class="label label-sm label-success"> Available </td>
                                                                                <td>GHS {{\App\Product::getProductName($item->product_id)->price}} </td>
                                                                                <td> GHS {{\App\Product::getProductName($item->product_id)->price}} </td>
                                                                                <td> {{$item->qty}} </td>
                                                                                <td>0.00  </td>
                                                                                <td> 0.00</td>
                                                                                <td> GHS0.00  </td>
                                                                                <td> GHS {{\App\Product::getProductName($item->product_id)->price * $item->qty}} </td>
                                                                            </tr>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="well">
                                                            ...
                                                            <div class="row static-info align-reverse">
                                                                ...
                                                                <div class="col-md-3 value">GHS {{$order->amount}} </div>
                                                            </div>
                                                            <div class="row static-info align-reverse">
