...
{{--                                                <img src='{{\Illuminate\Support\Facades\Storage::url("products/$product->image")}}'  alt="{{$product->name}}" class="img-responsive img_0" />--}}
                                                <img data-src='{{\Illuminate\Support\Facades\Storage::url("products/$product->image")}}' src='{{\Illuminate\Support\Facades\Storage::url("products/$product->image")}}'  alt="" class="img-responsive img_dimensions" />
