                ...
                {{--<div class="rd-navbar-top-part">--}}
                    ...
                    {{--</div><div>--}}
                        ...
                        {{--<div class="top-items" id="top-list-items">--}}
                            ...
                            {{--@else--}}
                                {{--<a href="{{url('/my-collections')}}">My Collections</a>--}}
   ...
   @include('market.partials.nav_menu')
    ...
    <section data-min-height="250px"style="margin-top: 10px;" data-height="calc(100vh - 152px)" data-autoplay="true" class="swiper-container swiper-slider">
        <div class="swiper-wrapper">
            <div data-slide-bg="images/shopaff.jpg" class="swiper-slide">
            ...
            <div data-slide-bg="images/slider-02.jpg" class="swiper-slide">
                <div class="swiper-caption">
                    <div class="swiper-slide-caption">
                        <p data-caption-animate="fadeInDown" data-caption-delay="600" class="small veil reveal-md-block small">Posted by Shane Doe</p>
                        <h1 data-caption-animate="fadeInUp" data-caption-delay="200">Beautiful Design
                        </h1><a href="#" data-caption-animate="fadeInUp" data-caption-delay="450" class="btn btn-primary">Read more</a>
                    </div>
                </div>
            </div>
