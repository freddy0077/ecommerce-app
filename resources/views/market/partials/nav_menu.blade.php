    ...
    <div class="container">
        <div class="row row1">
            <ul class="largenav pull-right">
                ...
                <li class="upper-links"><a class="links" href="http://clashhacks.in/"><h6>Trending</h6></a></li>
        ...
        <div class="row row2">
            ...
            <div class="flipkart-navbar-search smallsearch col-sm-8 col-xs-11">
                <div class="row">
                    <input class="flipkart-navbar-input col-xs-11" type="text" placeholder="Search for Products, Brands and more" name="" style="color: black">
            ...
            <div class="cart col-sm-1">
                ...
                @if(Auth::check())
                    ...
                    <li class="upper-links dropdown" style="margin-left:0px; margin-top:10px">
