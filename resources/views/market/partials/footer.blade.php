        ...
        <div>
            <div class="brand">
                <a href="/" class="brand-name">
                    {{--<img src="images/logo-footer.png" alt="" width="159" height="50"></a>--}}
            </div>
            ...
            <div class="offset-top-20 offset-sm-top-5 offset-lg-top-0">
                <ul class="list-inline list-lg-inline-30 list-lg-dashed">
                    <li class="small">Copyright &copy; <span id="copyright-year"></span> {{config('app.name')}}. All rights reserved.
                    </li>
                    <li class="small reveal-block reveal-lg-inline-block"><a href="#">Terms & Conditions</a></li>
                    <li class="small reveal-block reveal-lg-inline-block"><a href="#">Privacy Policy</a></li>
                </ul>
            </div>
        </div>
    </div>
